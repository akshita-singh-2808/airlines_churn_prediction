...
def load_data():
    ...
    data_path = base_dir / "data" / "Final_Segments.csv"
...
st.sidebar.markdown("---")
st.sidebar.markdown("**Data:** 2017 Activity | **Model:** Logistic Regression | **AUC:** 0.74")
...
# PAGE 3 — MEMBER LOOKUP
    ...
    if loyalty_input > 0:
        ...
        if len(member) == 0:
            ...
            col2.metric("Tenure (months)",  int(member['Tenure_At_Cutoff']))
...
# PAGE 4 — RETENTION PLAYBOOK
    ...
    playbook = {
        "New At-Risk": {
            "icon"   : "🔴",
            "who"    : "Recently enrolled members with very few flights and 82% avg churn probability",
        ...
        "Dormant Members": {
            "icon"   : "🟠",
            "who"    : "Members with near-zero 2017 flights and 11+ months inactive",
        ...
        "High Value Vulnerables": {
            "icon"   : "🟡",
            "who"    : "Highest CLV segment ($13,698 avg) with 49% churn probability",
            ...
            "why"    : "Losing one High Value Vulnerable costs more than retaining 10 Dormant members"
        },
        "Stable Regulars": {
            "icon"   : "🟢",
            "who"    : "Largest segment (6,130 members), long tenure, moderate churn risk",
